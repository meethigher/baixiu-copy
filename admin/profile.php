...
<body>
    ...
    <div class="container-fluid">
      ...
      <form class="form-horizontal">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-6">
            <input id="slug" class="form-control" name="slug" type="type" value="NULL" placeholder="slug">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-6">
            <input id="nickname" class="form-control" name="nickname" type="type" value="NULL" placeholder="昵称">
  ...
  <script>
    $("#avatar").on("change",function (){
      ...
      //拿到我们要上传的文件
      let file=files[0];
      //FormData是html5中新增的成员，专门配合ajax操作，用来在客户端和服务端传递二进制数据
